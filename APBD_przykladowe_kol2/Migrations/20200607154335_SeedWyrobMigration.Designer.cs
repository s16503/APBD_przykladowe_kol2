            ...
            modelBuilder.Entity("APBD_przykladowe_kol2.Models.Zamowienie", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdZamowienia = 1,
                            DataPrzyjecia = new DateTime(2020, 6, 7, 17, 43, 34, 423, DateTimeKind.Local).AddTicks(3254),
                        ...
                        {
                            IdZamowienia = 2,
                            DataPrzyjecia = new DateTime(2020, 6, 7, 17, 43, 34, 427, DateTimeKind.Local).AddTicks(5607),
                            DataRealizacji = new DateTime(2020, 6, 7, 0, 0, 0, 0, DateTimeKind.Local),
                            IdKlienta = 2,
                            IdPracownika = 2,
                            Uwagi = "świeże ma być"
                        ...
                        {
                            IdZamowienia = 3,
                            DataPrzyjecia = new DateTime(2020, 6, 7, 17, 43, 34, 427, DateTimeKind.Local).AddTicks(6368),
                            DataRealizacji = new DateTime(2020, 6, 7, 0, 0, 0, 0, DateTimeKind.Local),
                            IdKlienta = 3,
                            IdPracownika = 2
                        });
